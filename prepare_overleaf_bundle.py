...
Generates an exhaustive IEEEtran conference paper compliant with IEEE subfig rules,
aligned hardware/software testbed specifications, complete 8-row Table I, references.bib,
and builds a flat overleaf_paper.zip with root-level assets.
"""
...
# 3. Write comprehensive paper/main.tex with IEEEtran subfig and aligned specs
...
\begin{figure*}[t]
\centering
\subfloat[Quality vs. Latency Pareto Frontier\label{fig:pareto}]{\includegraphics[width=0.32\textwidth]{figures/pareto_quality_vs_latency.png}}
\hfill
\subfloat[Relative Speedup vs. Baseline\label{fig:speedup}]{\includegraphics[width=0.32\textwidth]{figures/speedup_comparison.png}}
\hfill
\subfloat[Tail Latency Distribution ($p_{50}$ vs. $p_{95}$)\label{fig:tail_latency}]{\includegraphics[width=0.32\textwidth]{figures/tail_latency_p50_p95.png}}
